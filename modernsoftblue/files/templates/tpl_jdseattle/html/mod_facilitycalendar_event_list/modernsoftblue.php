<?php
/**
 * Facility Calendar Event List — Modern Soft Blue layout override (Joomla 3)
 * --------------------------------------------------------------------------------------
 ...
 * semibold titles, and secondary muted times with a clock icon.
 *
...
#<?php echo $msb_id; ?> .msb-card-title {
  position:relative;
  font-size:1.05rem;
  font-weight:700;
  letter-spacing:.2px;
...
#<?php echo $msb_id; ?> .msb-card-title::before {
  content:"";
  position:absolute;
  left:0; top:.1em;
...
#<?php echo $msb_id; ?> .msb-card--events::after {
  content:"";
...
#<?php echo $msb_id; ?> .facility-upcoming-events {
  list-style:none; margin:0 !important; padding:0 !important;
}
#<?php echo $msb_id; ?> .facility-upcoming-events li.row {
  display:flex !important; flex-wrap:nowrap !important;
  align-items:center; gap:.8rem;
  padding:.4rem .1rem !important; margin:0 !important;
  border-bottom:0 !important;
}
#<?php echo $msb_id; ?> .facility-upcoming-events + .facility-upcoming-events li.row {
  border-top:1px solid #eef3f8 !important;
}
#<?php echo $msb_id; ?> .facility-col-1 {
  float:none !important; width:auto !important; flex:0 0 auto;
}
#<?php echo $msb_id; ?> .facility-event-date {
...
#<?php echo $msb_id; ?> .facility-upcoming-events li.row:hover .facility-event-date {
  transform:translateY(-2px);
  box-shadow:0 4px 10px rgba(24,144,215,0.15);
}
#<?php echo $msb_id; ?> .facility-event-month {
...
#<?php echo $msb_id; ?> .facility-event-day {
...
#<?php echo $msb_id; ?> .facility-col-2 { min-width:0; }
#<?php echo $msb_id; ?> .facility-col-2 > div:first-child {
  font-size:.95rem; font-weight:600; color:#1c2b3a; line-height:1.3;
}
#<?php echo $msb_id; ?> .facility-col-2 a { color:#1890d7; text-decoration:none; }
#<?php echo $msb_id; ?> .facility-col-2 a:hover { text-decoration:underline; }
#<?php echo $msb_id; ?> .facility-col-2 a::after {
  content:"\203A"; margin-left:4px; color:#1890d7; font-weight:700;
}
#<?php echo $msb_id; ?> .facility-event-time {
  margin-top:.18rem; font-size:.7rem; font-weight:600;
  letter-spacing:.5px; text-transform:uppercase; color:#7a8ba0;
  display:flex; align-items:center; gap:.32rem;
  line-height:1 !important;
}
#<?php echo $msb_id; ?> .facility-event-time::before {
...
<div id="<?php echo $msb_id; ?>">
  <section class="msb-card msb-card--events">
    <?php if (trim($module->title) !== '') : ?>
      <h3 class="msb-card-title"><?php echo $module->title; ?></h3>
    <?php endif; ?>
